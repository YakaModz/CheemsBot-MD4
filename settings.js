...
global.socialm = "Whatsapp Group" //ur github or insta name
...
//damtabase
global.premium = ['94768480793'] //ur premium numbers
global.ntilinkytvid = []
global.ntilinkytch = []
global.ntilinkig = []
global.ntilinkfb = []
...
global.mess = {
    ...
    banChat: 'මෙම සමූහයේ බොට් එක තහනම් කර ඇත, කරුණාකර තහනම් කිරීම ඉවත් කිරීමට හිමිකරු අමතන්න'
 banned in this group, please contact the owner to unban'
}
    global.limitawal = {
    premium: "Infinity",
    free: 12,
